...
function add_to_list(e) {
    ...
    var f = `<td style="display:flex;flex-direction: row;align-items: flex-end;justify-content: space-between;">
        ...
        <td class="text-right">
            ...
            <input class="form-control input-sm text-center rprice" style="width:100%;" type="${e.no_name !== 1 ? `text` : 'hidden'}" value="${e.product_price}" id="pro_price_${c}" ${e.no_name !== 1 ? `name="net_price[]" readonly` : 'readonly'} onClick="this.select()">
        </td>
        <td>
