...
function addProductToListByID(product_id,product_name,product_code,product_price,product_part_no,product_oem_part_number,item_cost,qty){
	//alert(product_id);
...
function isAddedProduct(pid,pq){
