...
function deleteExpensesItem(row_id){
...
function calculateTotal(){
	...
	for(i=1; i<=rowCount; i++){
		...
		var quantity_fld='';
		var cost_fld='';
		quantity_fld='#expitm_qty_'+i;
		var item_cost_fld='#product_cost_'+i;
		subtotal_fld='#sub_total_item_'+i;
		discount_fld='#expitm_dis_'+i;
		discount_val_fld='#expitm_dis_val_'+i;
		...
		var sale_inv_discount=($('#exp_discount').val());
		...
		//	alert(discount_fld);
			...
			$(subtotal_fld).val((afterDiscount));
	...
	$('#po_total').val(convertToAmount2Des(po_total));
	$('#po_discount').val(po_discount);
	$('#po_discount_amt').val(po_discount_amt);
	$('#po_vat').val(po_vat);
	$('#exp_net_total').val(convertToAmount2Des(po_net_total));
