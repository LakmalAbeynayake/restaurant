...
function loadItems(e) {
    ...
    f = '<td><input type="hidden" value="' + e.product_id + '" class="rid" name="product_id[]" id="product_id_' + e.product_id + '" row_id="' + c + '"><input type="hidden" value="' + e.product_code + '" class="rcode" name="product_code[]"><input type="text" value="' + e.product_name + '" placeholder="'+e.product_code+'" class="rname form-control input-sm" name="product_name[]" onClick="this.select()"></td>';
    f += '<td class="text-right"><input class="form-control input-sm text-center rquantity rprice" style="width:100%;" type="text" type="text" value="' + e.product_price + '" id="sprice_' + c + '" name="net_price[]" onClick="this.select()"></td>"';/* ondblclick="enable_(this)" onclick="this.select" onblur="disable_(this)" readonly*/
    f += '<td><input type="text" role="textbox" tabIndex="' + c + '" aria-haspopup="true" class="form-control input-sm text-center rquantity " name="quantity[]" value="1" data-item="' + e.product_id + '" id="quantity_' + c + '" onclick="this.select()"></td>';
...
function loadItemsDef(e) { /*console.log('load items - def');*/
    ...
    f += '<td><input type="text" role="textbox" tabIndex="' + c + '" aria-haspopup="true" class="form-control input-sm text-center rquantity " name="quantity[]" value="' + parseInt(e[0].qty) + '" data-id="1451881153671" data-item="' + e[0].product_id + '" id="quantity_' + c + '" onclick="this.select;"></td>';
