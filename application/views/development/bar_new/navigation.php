  ...
  <div class="container" style="background-color:#000;max-height: 42px;">
    ...
    <div class="header-nav">
      <ul class="nav nav-tabs navbar-nav tab-green no-print" id="myTab3">
        <li class="active"> <a data-toggle="tab" href="#Sales" style="padding:10px">
          <?php if($sale_id) echo 'EDIT SALE :'.$sale_details[0]['sale_reference_no'].' ['.$sale_id.' ]'; else echo ' NEW SALE' ?>
          </a> </li>
        <?php if(!$sale_id) { ?>
        <li> <a data-toggle="tab" href="#dine_in" style="padding:10px"><i class="fa fa-spoon"></i><i class="fa fa-circle-o"></i> Dine In </a> </li>
        <li> <a data-toggle="tab" href="#take_away" style="padding:10px"><i class="fa fa-money"></i> Take Away </a> </li>
        <li> <a data-toggle="tab" href="#delivery" style="padding:10px"><i class="fa fa-truck"></i> Delivery </a> </li>
        ...
        <li> <a href="<?php echo base_url("bar");?>" target="_blank" style="padding:10px"><i class="fa fa-plus-square"></i> New Sale </a> </li>
      </ul>
      <?php }?>
