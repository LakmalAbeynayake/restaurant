			...
			<div class="main-content">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Ingredient Stock Adjesent List</h1>
							</div>
                    ...
                    <div class="row">
						<div class="col-md-12">
							<?php if ($error ==1) {
								echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">×</button>Ingredients successfully added </div>';
							?>
        ...
        <script>
			...
			function products_load() {
					    ...
					    $('#products_table').DataTable({
					        "ajax": "<?php echo base_url('stock_adjesment/get_list_ingredient') ?>",
					        "bDestroy": true,
					        "iDisplayLength": 10,
