      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li> <a href="<?php echo base_url('sales'); ?>">  SHIFT CLOSE </a> </li>
            <li class="active">  </li>
            <li class="search-box">
...
?>
                ...
                </div><form role="form" class="form-horizontal" id="cash_counter_form" method="post">
      ...
      <div class="row">
        <div class="col-md-12"> 
          ...
          <div class="panel panel-default">
            <div class="panel-heading" id="scrollHere"> <i class="fa fa-plus"></i>SHIFT CLOSE</div>
            ...
            <div class="panel-body">
              ...
              <div class="alert alert-success" style="display:none;">
                ...
                <div class="col-sm-6 panel panel-default" style="padding: 15px;">
                  ...
                  <div class="col-md-12 row" style="border-top:#CCC solid 1px;">
                    <div class="col-sm-2">
                      <label class="fa-2x"></label>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-5" style="padding: 5px;">
                      <input readonly style="background-image:linear-gradient(to bottom, #f9f13f10 0%, #eceaf3 100%)" type="text" id="label-cash_in_hand" class="form-control auto" name="acctrnss_amount"   data-d-group="2" value="0.00" required>
                    </div>
                  </div>
                  <div class="col-md-12 row">
                    <div class="modal-footer" style="margin-bottom:10px;">
                      <button type="submit" class="btn btn-primary" name="" id=""> END SHIFT </button>
                ...
                <div class="col-sm-6"> 
                  ...
                  <div class="form-group">
                      <label class="col-sm-6 control-label" for="balance"> Cheque On Hand</label>
                      <div class="col-sm-6">
                        <input type="number" id="cheque" class="form-control auto" name="cheque" data-a-sign="Rs. "  data-d-group="2" value="0.00" >
                      </div>
                    </div>
                    
                  <div class="form-group">
                      <label class="col-sm-6 control-label" for="balance"> VISA Card </label>
                      <div class="col-sm-6">
                        <input type="number" id="visa_card" class="form-control auto" name="visa_card" data-a-sign="Rs. "  data-d-group="2" value="0.00" >
                      </div>
                    </div>
                    
                    <div class="form-group">
                      <label class="col-sm-6 control-label" for="balance"> MASTER Card </label>
                      <div class="col-sm-6">
                        <input type="number" id="master_card" class="form-control auto" name="master_card" data-a-sign="Rs. "  data-d-group="2" value="0.00" >
                      </div>
                    </div>
                    
                    <div class="form-group">
                      <label class="col-sm-6 control-label" for="balance"> AMEX Card </label>
                      <div class="col-sm-6">
                        <input type="number" id="amex_card" class="form-control auto" name="amex_card" data-a-sign="Rs. "  data-d-group="2" value="0.00" >
                      </div>
                    </div>
...
$(document).keypress(function(e) {
	...
	if(isNaN(e.key))if(e.target.id != 'remarks')e.preventDefault();
...
$(document).on('submit',function(){
	...
	$.post( "<?php echo base_url();?>cash_balance/save_cash_float_close", fields)
	  .done(function( data ) {
	...
	u=location.href;
	t=document.title;	
	window.open('<?php echo base_url('cash_balance/chashier_float_summay?id=') ;?>'+id,'sharer','toolbar=0,status=0,width=700,height=700, left=10, top=10,scrollbars=yes');return false;
	window.alert(id);
