...
<body onLoad="<?php echo $print_text; ?> <?php echo $close_text; ?>">
    <div class="print_area print" style="width:100%;">
      ...
      <p class="text-center" style="font-weight:bold; font-size:17px;">Mobile Phone & Accessories</p> -->
                ...
                <p style="padding:3px; font-weight:bold;">CASHIER SHIFT DETAILS REPORT</p>
      ...
      <div class="row col-md-12">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-stripe" class="saletable" id="saletable" >
                        <thead>
                            <tr>
                          <th>DISCRIPTION</th>  
                           <th>TYPE</th>  
                        ...
                        <tbody>
                            ...
                            <?php foreach($category_list as $cat){?> 
                             <tr>
                                ...
                                <td> <p style="text-align:center;"><?php echo $cat['cat_name'];?></p> </td>
                                <td><p style="text-align:right;"><?php echo  number_format($cat['cat_sale_total'], 2, '.', ','); ?></p></td>
                            ...
                            <?php } ?>
                             ...
                             <tr>
                              ...
                              <tr>
                                ...
                                <td><p style="text-align:right; border-bottom: 3px double; "><strong><?php echo  number_format($retail_sale_total, 2, '.', ','); ?></strong></p></td>
                                <td><p style="text-align:right; border-bottom: 3px double; "><strong><?php echo  number_format($expencess_total, 2, '.', ','); ?></p></strong></td>
                            </tr>
        ...
        <tr>
            ...
            <td></td>
             ...
             <!--           <tr>
                ...
                <!--<hr>-->
                <h4>CASH SUMMARY</h4>
                <table class="table table-stripe" id="cashtable">
                    <!--<tr>
                        <td width="10%">
                        </td>
                        <td width="10%">
        ...
        <tr>
            ...
            <td></td>
                    ...
                    <tr>
                        <td>
                            <stong> = Cash in Hand (System)</stong>
                        </td>
                        <td>:</td>
                        <td>
                            <stong><?php echo number_format(($opening_balance + $sale_cash_total + $tranfer_pettycash_total) - ($withdraval_total + $expencess_total + $sale_return_cash_total), 2, '.', ','); ?></stong>
                        </td>
                    </tr>
                    
                    <tr>
                        <td>
                            <stong> = Cash in Hand (Physical)</stong>
                        </td>
                        <td>:</td>
                        <td>
                            <stong><?php echo number_format($closing_balance, 2, '.', ','); ?></stong>
                        </td>
                    </tr>
                     
                    <tr>
                        <td>
                            <stong> Difference</stong>
                        </td>
                        <td>:</td>
                        <td>
                            <stong><?php echo number_format($closing_balance - (($tranfer_pettycash_total + $sale_cash_total + $opening_balance) - ($withdraval_total + $expencess_total + $sale_return_cash_total)), 2, '.', ','); ?></stong>
                        </td>
                    </tr>
                </table>
                <hr>
               <?php /* <h4>CARD PAYMENTS</h4>
          ...
          <!--  <h4>Other</h4>
            <table class="table">
                ...
                <tr>
                    <th>CASH</th>
                    <th><?php echo number_format($wife_cash,2,'.',',') ?></th>
                    <th><?php echo number_format($husband_cash,2,'.',',') ?></th>
                </tr>
                <tr>
                    <th>CARD</th>
                    <th><?php echo number_format($wife_card,2,'.',',') ?></th>
                    <th><?php echo number_format($husband_card,2,'.',',') ?></th>
                </tr>
            </table>
            -->
