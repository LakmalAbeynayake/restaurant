...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading"> <i class="fa fa-plus"></i> Add Sales </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label for="customer_id">Qutation No * </label>

                                                            <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $qts_details['customer_id'] ?>">
                                                            <input type="hidden" id="qts_id" name="qts_id" value="<?php echo $qts_details['qts_id'] ?>">
                                                            <input type="text" class="form-control" id="qty_ref" name="qty_ref" value="<?php echo $qts_details['qts_reference_no'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="in_type" class="form-control search-select" name="in_type">
                                                                ...
                                                                $sel_h = '';
                                                                /*
					if(isset($hdr_data->bkng_status) && $hdr_data->bkng_status=='Requested'){
						$sel_p=' selected';
					}
					if(isset($hdr_data->bkng_status) && $hdr_data->bkng_status=='Confirmed'){
						$sel_c=' selected';
					}
					if(isset($hdr_data->bkng_status) && $hdr_data->bkng_status=='Removed'){
						$sel_r=' selected';
					}*/

                                                                ?>
                                                                <option value="Cash" <?php echo $sel_c; ?>>Cash</option>
                                                                <option value="Credit" <?php echo $sel_cr; ?>>Credit</option>
                                                                <option value="Wholesale" <?php echo $sel_h; ?>>Wholesale</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="well well-sm">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group wide-tip">
                                                    ...
                                                    <input type="text" placeholder="Please add products to order list" id="add_item" class="form-control input-lg" value="" name="add_item" onClick="add_items()" style="border-radius: 6px;font-size: 18px;height: 46px;line-height: 1.33;padding: 10px 16px;" readonly>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="modal-footer" style="margin-bottom:10px;">
                                            <input type="submit" class="btn btn-primary" value="Add Sales" name="add_sale" id="add_sale">
                                    ...
                                    <input name="uuidv4" type="hidden" id="uuidv4" value="">
                                </form>
    ...
    <script src="<?php echo asset_url(); ?>js/sales_qty.js"></script>
    ...
    <script>
        ...
        function get_count() {
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    localStorage.setItem(['adv' + getCurrentDate()], next_id);
                }
            });
        }

        function createId(branchCode, shift_id) {
            // Retrieve the last ID from local storage
            var next_id = parseInt(localStorage['adv' + getCurrentDate()]);
            ...
            if (isNaN(next_id)) {
                ...
                localStorage.setItem(['adv' + getCurrentDate()], 1);
                next_id = 1;
            } else {
                localStorage.setItem(['adv' + getCurrentDate()], ++next_id);
            }
        ...
        function insertSalesData() {
            var branchCode = '<?php echo $this->session->userdata('ss_warehouse_id'); ?>';
            var shift_id = '<?php echo $this->session->userdata('ss_cashier_float_id'); ?>';
            $('#sale_id').val(createId(branchCode, shift_id));
            ...
            if (rowCount != 0) {
                ...
                $.post("<?php echo base_url(); ?>sales/save_sales_advance", fields)
                    .done(function(data) {
                        var obj = jQuery.parseJSON(data);
                        if (obj.error == 1) {
                            $('.alert-success').hide();
        ...
        function add_item() {
            <?php foreach ($qts_item_list as $row) { ?>
                addProductToListByID(<?php echo $row['product_id'] ?>, '<?php echo $row['product_name'] ?>', '<?php echo $row['product_code'] ?>', <?php echo $row['unit_price'] ?>, '', '', <?php echo $row['unit_price']; ?>, <?php echo $row['quantity']; ?>, <?php echo $row['discount_val']; ?>);
            <?php } ?>
        }
