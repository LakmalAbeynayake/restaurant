...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                Quotation Number <?php echo $qts_id ?>
                            ...
                            <div class="panel-body">
                                <div class="well well-sm">
                                    <div class="col-xs-4 border-right">
                                        ...
                                        <div class="col-xs-10">
                                            <h4 class="">Reference No : <?php echo $qts_details['qts_reference_no']; ?></h4>
                                            <p>Date: <?php echo display_date_time_format($qts_details['qts_datetime']) ?></p>
                                            <p> Invoice No <?php echo $qts_details['sale_reference_no']; ?> Date : <?php echo $qts_details['sale_datetime']; ?></p>
                                ...
                                <div class="col-xs-5">
                                    <input name="qts_id" type="hidden" id="qts_id" value="<?php echo $qts_id ?>">
                                    ...
                                    <table class="table table-bordered table-hover table-striped print-table order-table">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td style="text-align:right; padding-right:10px;"><?php echo number_format($qts_details['qts_inv_discount_amount'], 2, '.', ',') ?></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align:right; padding-right:10px;" colspan="5">Total Amount
                                                </td>
                                                <td style="text-align:right; padding-right:10px;"><?php echo number_format($qts_details['qts_total'], 2, '.', ',') ?></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                ...
                                <div class="well well-sm col-xs-6 pull-right">
                                    <div class="col-xs-10">
                                        <p>Created by : <?php echo $qts_details['user_first_name']; ?> (<?php echo $qts_details['user_id']; ?>) </p>
                                        <p>Date:<?php echo display_date_time_format($qts_details['qts_datetime_created']) ?></p>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="clearfix"></div>
                                                    ...
                                                    <?php foreach ($sale_payments_list as $row) { ?>
                                                        <tr <?php echo $row->valid_status ? '':'class="strikethrough"' ?>>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if($this->session->userdata('ss_group_id') < 3  && $qts_details['qutation_status'] == 1){?>
                                ...
                                <div class="buttons">
                                    <div class="btn-group btn-group-justified">
                                        ...
                                        <?php 
                                                if($qts_details['qutation_status'] == 1){
                                            ?>
                                                <div class="btn-group"><a title="" class="tip btn btn-warning tip" href="<?php echo base_url() ?>quotations/add/<?php echo $qts_id ?>"><i class="fa fa-edit"></i> <span class="hidden-sm hidden-xs">Edit Quotation</span></a></div>
                                            <?php }?>
                                        
                                        <div class="btn-group"><a title="" class="tip btn btn-default tip" href="<?php echo base_url() ?>quotations/invoice_qutation?id=<?php echo $qts_id ?>"><i class="fa fa-shopping-cart"></i> <span class="hidden-sm hidden-xs">Invoice </span></a></div>
                                        <div class="btn-group"><a title="" class="tip btn btn-success tip" data-target="#ajax-modal" data-toggle="modal" href="#" data-original-title="Add Payment"><i class="fa fa-money"></i> <span class="hidden-sm hidden-xs">Advance Payment</span></a></div>
                                        ...
                                        <div class="btn-group" onClick="fbs_click(<?php echo $qts_id; ?>)"><a title="" class="tip btn btn-primary" data-original-title="Print"><i class="fa fa-print"></i> <span class="hidden-sm hidden-xs">Print</span></a></div>
                                    </div>
                                </div> <!--buttons-->
                            
                            <?php
                                /*$this->db->select('*');
                                $this->db->from('quotations_log');
                    ...
                    <div class="col-md-12">
                        <div class="col-sm-5">
                            <div class="form-group has-feedback">
                                <input name="sale_id" type="hidden" id="sale_id" value="<?php echo $qts_id; ?>" />
    ...
    function sale_pymnts_delete_by_sp_id(sp_id,elem){
        ...
        bootbox.confirm(msg,(e)=>{
            if(e){
                $.ajax({
                    'url' : '<?php echo base_url() ?>sales/qts_pymnts_delete_by_sp_id',
                    'dataType' : 'json',
                    'data' : {
                        sp_id : sp_id
                    },
