  ...
  <div class="navigation-toggler">
					...
					<ul class="main-navigation-menu">
						...
						<li <?php if($main_menu_name=='people') {echo 'class="active open"';} ?>>
							...
							?>
                              ...
                              <?php }?>  
                                ...
                                <?php } ?>
								<?php 
								if(in_multiarray("usrgp_permission_page","customer", $usr_permtn_pubvr,"usrgp_permission_view",1))
								{?>
                                ...
                                <?php }?>
                                <?php 
								if(in_multiarray("usrgp_permission_page","customer", $usr_permtn_pubvr,"usrgp_permission_add",1))
								{?>
								<li>
						...
						<li <?php if($main_menu_name=='reports') {echo 'class="active open"';} ?>>
							...
							<ul class="sub-menu">
                            <li <?php if($sub_menu_name=='daily_sales') {echo 'class="active open"';} ?>>
									<a href="<?php echo base_url('reports/daily_sales'); ?>">
                                ...
                                <li <?php if($sub_menu_name=='products_quantity') {echo 'class="active open"';} ?>>
									<a href="<?php echo base_url('reports/products_quantity'); ?>">
										<span class="title"> Products Quantity Report</span>
									</a>
								
								</li>
                                <li <?php if($sub_menu_name=='supplier_products') {echo 'class="active open"';} ?>>
									<a href="<?php echo base_url('reports/supplier_products'); ?>">
										<span class="title"> Supplier Products Report</span>
									</a>
								
								</li>
                                 <li <?php if($sub_menu_name=='print_product_code') {echo 'class="active open"';} ?>>
									<a href="<?php echo base_url('reports/print_product_code'); ?>">
										<span class="title"> Products Code Print</span>
									</a>
                                ...
                                <li <?php if($sub_menu_name=='user_activitie') {echo 'class="active open"';} ?>>
									<a href="<?php echo base_url('reports/alert_quantity'); ?>">
										<span class="title"> Alert Quantity</span>
									</a>
								</li>
							</ul>
						</li>
