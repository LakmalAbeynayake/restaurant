								...
								<div class="panel-heading">
                                    ...
                                    <div class="panel-tools" style="top:2px;">
												...
												<ul class="dropdown-menu dropdown-light pull-right">
														<li>
															<a id="" data-toggle="modal" href="<?php echo base_url('service/manage/0'); ?>">
        ...
        <script>
			...
			function loadGrid() {
					    ...
					    $('#warehouse_table').DataTable({
					        "ajax": "<?php echo base_url('service/list_service') ?>",
					        "bDestroy": true,
					        "iDisplayLength": 10,
							"order": [[ 0, "desc" ]]
					    });
...
function click_service_view_btn(req_id){	
	var $modal = $('#ajax-modal');
	 $('body').modalmanager('loading');
			setTimeout(function () {
				$modal.load('<?php echo base_url("service/service_details?req_id="); ?>'+req_id, '', function () {
					$modal.modal();
...
function fbs_click(id) {
	u=location.href;
	t=document.title;
	window.open('service/service_print/'+id,'sharer','toolbar=0,status=0,width=626,height=700, left=10, top=10,scrollbars=yes');return false;
