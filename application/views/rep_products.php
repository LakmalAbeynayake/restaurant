								  ...
								  <table class="table table-bordered table-condensed table-hover table-striped dataTable" id="products_table" style="overflow:scroll">
									  <thead>
							              <tr>
                                            ...
                                            <th>Category</th>
                                            <th class="col-md-1">Open Stock</th>
                                            <th class="col-md-1">Purchased QTY</th>
                                            <th class="col-md-1">Sold Qty</th>
                                            <th class="col-md-1">Wastage</th>
                                            <th class="col-md-1">Staff Meal</th>
                                            <th class="col-md-1">Adjesment</th>
                                            <th class="col-md-1">Close Balance</th>
                                            <th class="col-md-1">Purchase Value Tot</th>
                                            <th class="col-md-1">Sale Value Tot</th>
                                            <th class="col-md-1">Waste Value</th>
                                            <th class="col-md-1">S.Meal Value</th>
                                            <th class="col-md-1">Adj. Value</th>
                                            <th class="col-md-1">Close Value</th>
                                    </tr>
							          </thead>
...
//											message:	"Baker's Choice, \n <?php echo $warehouse_details['address']; ?></b>",
					        ...
					        "ajax": {
							'type': 'POST',
							'url': '<?php echo base_url('reports/get_list_product_for_print');?>',
							'data': {
