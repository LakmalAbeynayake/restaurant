											...
											<div class="panel panel-default">
												<div class="panel-heading" style="font-weight: 700;">Please select these before adding any product</div>
													<div class="panel-body">
                                                        ...
                                                        <div class="col-sm-4">
                                                      	<div class="form-group">
															<label for="customer_id">Sale Terms * </label>
				...
				?> 
                  ...
                  <option value="Wholesale"<?php echo $sel_h; ?>>Wholesale</option>
                        ...
                        <div class="modal-footer" style="margin-bottom:10px;">
            				<input type="submit" class="btn btn-primary" value="Add Orders" name="add_sale" id="add_sale"> <button id="reset" class="btn btn-danger" type="button">Reset</button>
            			</div>
                        </div>
...
function getNextRefNo(){
	...
	$.post( "<?php echo base_url();?>order/get_next_ref_no")
	  .done(function( data ) {
		  var obj = jQuery.parseJSON(data);
...
function insertSalesData(){
	...
	$.post( "<?php echo base_url();?>order/save_sales", fields)
	  .done(function( data ) {
		  var obj = jQuery.parseJSON(data);
			if(obj.error==1){
			...
			if(obj.error==0){
				...
				$("#soTable > tbody").empty();
				displayNotice('page','Order successfully added!');
				
				clearForm();
				//empty footer details
				
				//alert(obj.sale_id);
				sendUrl='order/view/'+obj.sale_id;
				//alert(sendUrl);
...
function add_items(){
		...
		{
            source: '<?php echo base_url();?>order/suggestions?t='+$("#in_type").val(),
            minLength: 1,
            autoFocus: false,
            delay: 5,
