 ...
 <form role="form" class="form-horizontal" id="user_change_pw_form" action="#" method="post">
...
<!--  											<div class="col-md-12">
		...
		<script src="<?php echo asset_url(); ?>js/form-validation-user_change_pw.js"></script>
	...
	//alert(1);
		...
		function user_change_pw(form) {
               $('body').modalmanager('loading');
                setTimeout(function () {
                    $.ajax({
                    url: "<?php echo base_url('users/user_change_pw_submit'); ?>", // Url to which the request is send
                        ...
                        success: function(data)   // A function to be called if request succeeds
                        {
                            ...
                            if (obj.status==0) 
                                ...
                                else
                                {
									...
									//alert(obj.type);
										$('#error').hide();
										document.getElementById("user_change_pw_form").reset();
										set_message('User Notice!','User password successfully Updated');
										setTimeout(function(){
