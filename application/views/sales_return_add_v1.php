	...
	<!-- end: HEAD -->
		...
		<link rel="stylesheet" type="text/css" href="http://sma.tecdiary.org/themes/default/assets/styles/helpers/jquery-ui.css">
...
<input type="hidden" id="product_id_<?php echo $tmpcount ?>" value="<?php echo $product_id ?>" name="row[<?php echo $tmpcount ?>][product_id][]" class="form-control text-center rquantity"></td>
                <td class="text-right"><input type="hidden" value="<?php echo $row['unit_price'] ?>" id="product_price_<?php echo $tmpcount ?>" name="row[<?php echo $tmpcount ?>][unit_price][]"><?php echo number_format($row['unit_price'], 2, '.', ',') ?></td>
                ...
                <input type="text" style="width:50px; border:0; background-color:transparent;" readonly id="discount_<?php echo $tmpcount ?>" value="<?php echo $row['discount']; ?>" name="row[<?php echo $tmpcount ?>][discount][]">
                 </span>
                ...
                <td class="text-right">
                <span id="subtotal_<?php echo $tmpcount ?>" class="text-right ssubtotal"><?php echo number_format($row['gross_total'], 2, '.', ',') ?></span>               
...
<label for="payment_reference_no">Payment Reference No *</label> <input type="text" required id="payment_reference_no" class="form-control tip" value="" name="payment_reference_no" data-bv-field="payment_reference_no" data-original-title="" title="">
...
<div class="payment">
<div class="form-group">
<label for="amount_1">Amount *</label> <input type="text" class="pa form-control kb-pad amount" id="sale_pymnt_amount" name="sale_pymnt_amount">
</div>
</div>
</div>
...
<!--end start return note-->                      
                        ...
                        <input name="sl_rtn_total" type="text" id="sale_total" value="<?php echo $sale_details['sale_total'] ?>">
