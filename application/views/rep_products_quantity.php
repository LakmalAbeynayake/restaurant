					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Products Quantity Report</h1>
							</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
                                    ...
                                    <div class="panel-tools" style="top:2px;">
												<!--<button onClick="JavaScript:fbs_click('<?php echo base_url('reports/print_products_quantity/'); ?>');" class="btn btn-blue dropdown-toggle" data-toggle="dropdown">
			...
			function products_load() {
				...
				var cat_srh=$('#cat_srh').val();
					    ...
					    $('#products_table').DataTable({
					        "ajax": {
							'type': 'POST',
							'url': '<?php echo base_url('reports/get_list_product_qty_for_print');?>',
							'data': {
