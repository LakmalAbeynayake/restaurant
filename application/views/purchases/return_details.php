                                                    ...
                                                    <tbody>
                                                        <?php foreach ($po_middle as $po_middle) { ?>
                                                            <tr>
                                                                ...
                                                                <td style="width: 120px; text-align:right; vertical-align:middle;"> 0.00 <?php //echo $po_middle->discount; ?></td>
            ...
            function approve() {
                bootbox.confirm("Are you sure?", (a) => {
                    if (a) {
                        ...
                        var purchase_id = <?php echo $po_header[0]->pr_id; ?>;
                        var jsonData = {
                        ...
                        // AJAX POST request
                        $.ajax({
                            url: "<?php echo base_url() ?>purchases/approve_return",
                            type: "POST",
                            dataType: "json",
                            data: jsonData,
                            statusCode: {
