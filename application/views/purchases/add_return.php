                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                Please fill in the information below. The field
                            labels marked with * are required input fields.
                            </div>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                $reference_no = $ref_id->gen_ref_number('pr_id', 'purchases_return', 'PRT/');
                                                ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                    ...
                                                    <?php if(isset($purchased_details)){?>
                                                    
                                                    <input id="supplier" name="supplier" value="<?php echo  $purchased_details[0]->id ?>">
    ...
    <script>
        ...
        function insertSalesData() {
            ...
            if (rowCount != 0) {
                ...
                $.post("<?php echo base_url(); ?>purchases/save_purchases_return", fields)
                    .done(function(data) {
                        var obj = jQuery.parseJSON(data);
                        if (obj.error == 1) {
        ...
        function add_items() {
            ...
            $("#add_item").autocomplete({
                source: '<?php echo base_url(); ?>purchases/suggestions?t=' + $("#in_type").val()+'&purchased_id=<?php echo isset($purchased_id) ? $purchased_id : "" ?>',
                minLength: 1,
                autoFocus: false,
                delay: 5,
