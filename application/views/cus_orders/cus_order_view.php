                            ...
                            <div class="panel-body">
                                <div class="well well-sm">
                                    <div class="col-xs-4 border-right">
                                        ...
                                        <div class="col-xs-10">
                                            <h4 class="">Reference No : <?php echo $qts_details->order_id; ?></h4>
                                            <p>Date: <?php echo display_date_time_format($qts_details->added_on) ?></p>
                                            <p>Delivery Date: <?php echo display_date_time_format($qts_details->delivery_date) ?></p>
                                        </div>
                                    ...
                                    <div class="col-xs-4 border-right">
                                        ...
                                        <div class="col-xs-10">
                                            <h4 class=""><?php echo $qts_details->cust_name; ?></h4>
                                            <?php echo $qts_details->delivery_address; ?><br>
                                            <p></p>
                                            Tel: <?php echo $qts_details->cust_phone; ?><br>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <div class="col-xs-10">
                                            ...
                                            echo $warehouse_details['name']; ?></h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:right; width:120px; padding-right:10px;"><?php echo $row['subtotal']; ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:right; padding-right:10px;"><?php echo number_format($qts_details['custom_order_total'], 2, '.', ',') ?></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                ...
                                <div class="buttons">
                                    <div class="btn-group btn-group-justified">
                                        ...
                                        <div class="btn-group" onClick="fbs_click(<?php echo $qts_id; ?>)"><a title="" class="tip btn btn-primary" data-original-title="Print"><i class="fa fa-print"></i> <span class="hidden-sm hidden-xs">Print</span></a>
                                        </div>
                                    </div>
                                </div> <!--buttons-->
                            </div> <!--panel-body-->
