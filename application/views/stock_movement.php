...
<th  width="">Balance Stock</th>
<th  width=""> Sale Unit Price Rs. </th>
<th  width=""> Sale Value </th>
<th  width=""> Purchase   
 Value </th>
<th  width=""> Purchase  
 Amount 
...
function reset_datatable(){
	...
	var srh_to_date=$('#srh_to_date').val();
	 ...
	 //TableData.init();
	 	var message="<div style='text-align:center'><h4>"+warehouse_name+"</h4> <h4>Sales Statement</h4><h5>From Date: "+srh_from_date+" , To Date: "+srh_to_date+", Created Date: <?php echo date("m/d/Y H:i:s"); ?></h5></div>";
		  ...
		  $('#total_product_qty_table').DataTable({
			  ...
			  "bDestroy": true,
			   "lengthMenu": [[50,10,150,-1], [50,10,150,'All']],
