          ...
          <input id="odr_id" name="odr_id" type='hidden' class="form-control" value="<?php echo $stm_id;?>"/>
              ...
              <thead>
                <tr>
                  ...
                  <th>UOM</th>
                   ...
                   <th>QTY</th>
                   <th>COST</th>
                   <th  class="col-sm-2" >SYSTEM NOTE</th>
                </tr>
              </thead>
              <tfoot>
                <tr>
            ...
            <div class="col-md-12"> 
             <div class=" pull-right ">
                <div class="form-group">
           <button type="button" class="btn btn-success pull-left " data-toggle="tooltip"  data-placement="center" title="FINISH MANUAL ORDER" onClick="final_order(<?php echo $details['odr_id']; ?>)" > <i class="fa fa-check" aria-hidden="true"></i> FINAL ORDER</button>
    </div>
    </div>
		...
		function loadGrid() {
		    var id=$('#odr_id').val();
					    $('#warehouse_table_1').DataTable({
					        "ajax": "<?php echo base_url('stock_m_transfer/get_details_transfer_item_list?id=')?>"+id,
					        "data": {
							   id: id,
							},
					        oLanguage: {
