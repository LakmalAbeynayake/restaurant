      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            <h3>LIST RAW MATERIAL TRANSFER   </h3>
          </div>
      ...
      <div class="row">
        <div class="col-md-12"> 
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> LIST RAW MATERIAL TRANSFER 
...
function loadGrid() {
    $('#warehouse_table').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo base_url('stock_m_transfer/get_transfer_list') ?>",
        "bDestroy": true,
        "iDisplayLength": 10,
        "order": [
            [0, "desc"]
