                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading"> <i class="fa fa-external-link-square"></i> Please use the table below to navigate or filter the results.
                                ...
                                <div class="col-sm-12">
                                    <div class="col-sm-2 <?php echo $this->session->userdata('ss_group_id') < 3 || $this->session->userdata('ss_group_id') == 4 ? '':'collapse';?>">
                                      <div class="form-group">
                                        ...
                                        <select id="warehouse_id" class="form-control search-select" name="warehouse_id" onchange="loadGrid()">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select id="sale_status" class="form-control">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select id="customer_id" class="form-control search-select">
                                                <option value="">-- all --</option>
                                                <?php 
                                ...
                                <table width="100%" class="table table-bordered table-condensed table-hover table-striped dataTable" id="warehouse_table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="no-sort">Sale Status</th>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('#srh_to_date').datetimepicker({
                defaultDate: moment(currentDate).hours(23).minutes(59).seconds(59).milliseconds(0)
            });
        ...
        function loadGrid() {
            ...
            var srh_location_id = $('#warehouse_id').val();
            var customer_id = $('#customer_id').val();
            
            var ss = $('#sale_status').val();
            ...
            $('#warehouse_table').DataTable({
                ...
                "bProcessing": true,
                "serverSide": true,
                "ajax": "<?php echo base_url('sales/list_sales?') ?>" + "srh_from_date=" + srh_from_date + "&srh_to_date=" + srh_to_date + "&srh_user_id=" + srh_user_id + '&srh_location_id='+srh_location_id+'&ss='+ss+'&ps='+ps+'&customer_id='+customer_id,
                "bDestroy": true,
                "iDisplayLength": 10,
                "order": [
                    [0, "desc"]
