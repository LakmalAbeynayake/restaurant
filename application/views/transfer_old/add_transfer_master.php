    ...
    <div class="row">
      <div class="col-md-12"> 
        ...
        <div class="panel panel-default">
          <div class="panel-heading"> <i class="fa fa-external-link-square"></i>  NEW TRANSFER 
        ...
        <div class="panel-body">
          ...
          <div class="col-md-12">
            ...
            <!-------------------- -->
            <div class="panel panel-default">
              <div style="font-weight: 700;" class="panel-heading"> NEW TRANSFER </div>
              <div class="panel-body"> 
...
// alert();
        ...
        $('#form_add_new_bulk_master').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: '<?php echo base_url();?>stock_transfer/save_trasfer_master',
            data: $('form').serialize(),
            success: function (data) {
              	var obj = jQuery.parseJSON( data );
              	if(obj.status==1){
              	 displayNotice( 'page', 'successfully added!' );
				  window.location.replace("<?php echo base_url().'stock_transfer/add_transfer_items?id='?>"+obj.result);
              	}else{
              	    bootbox.alert({
