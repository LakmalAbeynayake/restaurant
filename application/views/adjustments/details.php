						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<?php echo $po_header->adj_ref_no; ?> - 
									    Requested necessary adjustments to the stock for <b><?php echo $po_header->name; ?>(location)</b> on <b><?php echo date('Y-m-d H:i A', strtotime($po_header->date_time)); ?></b>
									</b>
								</div>
								<div class="panel-body">
									<div class="box-content">
									   <div class="row">
									      <div class="col-lg-12" style="min-height: 65vh;">
                                            ...
                                            <div class="col-xs-4 ">
									            <code style="padding:0">
									                Created On : <?php echo $po_header->created_on; ?><br>
									            ...
									            <table class="table table-bordered table-hover table-striped print-table order-table">
									               ...
									               ?>
									                  <tr>
									                     ...
									                     <td style="width: 120px; text-align:center; vertical-align:middle;"><?php echo number_format($po_middle->system_count, 2, '.',','); ?></td>
									                     <td style="text-align:right; width:120px; padding-right:10px;"><?php echo number_format($po_middle->physical_count , 2, '.',','); ?></td>
									                     <td style="text-align:right; width:120px; padding-right:10px;"><?php echo number_format($po_middle->adjustment, 2, '.',','); ?></td>
									                  </tr>
									                <?php } ?>
									      ...
									      <div class="btn-group btn-group-justified">
									          <?php if(!$po_header->approval_status){ ?>
                                                <div class="btn-group"><a data-toggle="modal" title="" class="tip btn btn-warning tip" href="#" onclick="approve()" id="approve" data-original-title="Add to Stock"><i class="fa fa-check"></i>
                                                    <span class="hidden-sm hidden-xs">Approve and apply changes</span></a>
									            </div>
									          <?php } ?>
									          <div class="btn-group"><a class="tip btn btn-success tip" href=""> <i class="fa fa-print"></i> <span class="hidden-sm hidden-xs">Print S.A </span></a></div>
									      </div>
									   </div>
									</div>
								</div>
    ...
    function approve(){
        bootbox.confirm("Are you sure?",(a)=>{
            if(a){
                ...
                // AJAX POST request
                $.ajax({
                    url: "<?php echo base_url()?>stock_adjesment/approve_adjustment",
                    type: "POST",
                    dataType: "json",
                    data: jsonData,
                    statusCode: {
