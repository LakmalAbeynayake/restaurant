						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									order Number <?php echo $order_details['order_id']; ?>
...
<div class="col-xs-10">
<h4 class="">Order No : <?php echo $order_details['order_reference_no'];?></h4>
<p>Date: <?php echo display_date_time_format($order_details['order_datetime'])?></p>
<?php 
$obj = new Order_Model();
...
?>
<p>orders Terms: <?php echo $order_details['in_type']; ?></p>
...
<div class="col-xs-5">
<input name="order_id" type="hidden" id="order_id" value="<?php echo $order_details['order_id']; ?>">
...
<td style="text-align:right; padding-right:10px;"><?php echo number_format($order_details['order_total'], 2, '.', ',') ?>
<input type="hidden" value="<?php echo $order_details['order_total']?>" id="total_paymnt_tmp">
...
<p>Date:<?php echo display_date_time_format($order_details['order_datetime_created'])?></p>
...
<div class="btn-group" onClick="fbs_click(<?php  echo $order_details['order_id']; ?>)"><a title="" class="tip btn btn-primary" data-original-title="Print"><i class="fa fa-print"></i> <span class="hidden-sm hidden-xs">Print</span></a>
</div>
