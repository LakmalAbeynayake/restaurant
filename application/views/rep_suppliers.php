							...
							<div class="panel panel-default">
								<div class="panel-heading">
                                    ...
                                    <div class="panel-tools" style="top:2px;">
												<button onClick="JavaScript:fbs_click('<?php echo base_url('reports/print_supplier/'); ?>');" class="btn btn-blue dropdown-toggle" data-toggle="dropdown">
        ...
        <script>
			...
			function loadGrid() {
					    ...
					    $('#warehouse_table').DataTable({
					        "ajax": "<?php echo base_url('reports/get_list_supplier_for_print') ?>",
					        "bDestroy": true,
					        "iDisplayLength": 10
					    });
...
function fbs_click(url) {
	u=location.href;
	t=document.title;
	window.open(url,'sharer','toolbar=0,status=0,width=626,height=436, left=10, top=10,scrollbars=yes');return false;
}
