                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                Customer Type <select class="search-select" id="cus_type" style="width:200px" onchange="loadGrid()">
                                ...
                                <div class="panel-tools" style="top:2px;">
                                    ...
                                    <ul class="dropdown-menu dropdown-light pull-right">
                                        <li>
                                            <a id="modal_ajax_customers_btn" data-toggle="modal" href="#">
    ...
    <script>
        ...
        function loadGrid() {
            $('#warehouse_table').DataTable({
                "ajax": {
                    'type' : 'post',
                    'url': "<?php echo base_url('customers/list_customer') ?>",
                    'data': {
            ...
            $("#conirm").click(function() {
                ...
                if (page == 'supp') {
                    if (popup_type == 'delete') {
                        $.post("customers/delete_customer", {
                                cus_id: cus_id
                            })
                            .done(function(data) {
                        ...
                        $.post("customers/disable_customer", {
                                cus_id: cus_id
                            })
                            .done(function(data) {
                                var obj = jQuery.parseJSON(data);
                        ...
                        $.post("customers/enable_customer", {
                                cus_id: cus_id
                            })
                            .done(function(data) {
                                var obj = jQuery.parseJSON(data);
