<?php //http://phpledger.com/demo/?route=modules/gl/transactions/journal_vouchers/view_journal_vouchers?>	
		...
		function searchDetails(){
			...
			var srh_warehouse_id=$('#srh_warehouse_id').val();
					    ...
					    $('#warehouse_table').DataTable({
							...
							"ajax": {
							'type': 'POST',
							'url': '<?php echo base_url('reports/get_list_trial_balance_for_print');?>',
							'data': {
