      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <ol class="breadcrumb">
            ...
            <li> <a href="<?php echo base_url('sales'); ?>"> chef </a> </li>
            <li class="active"> Add Schdule </li>
            <li class="search-box">
      ...
      <div class="row">
        <div class="col-md-12"> 
          ...
          <div class="panel panel-default">
            <div class="panel-heading"> <i class="fa fa-plus"></i> Add Schdule </div>
            <div class="panel-body">
              ...
              <form role="form" class="form-horizontal" id="create_chef_schdule_form" action="#" method="post">
                  ...
                  <div class="well well-sm">
                    <div class="form-group"> 
                      ...
                      <div class="input-group wide-tip">
                        ...
                        <input type="text" placeholder=" Please Select a chef name" id="add_item" class="form-control input-lg" value="" name="add_item" onClick="add_items()" style="border-radius: 6px;font-size: 18px;height: 46px;line-height: 1.33;padding: 10px 16px;">
                    ...
                    <div class="control-group table-group">
                      <label class="table-label"> Chef</label>
                      <div class="controls table-controls">
                        <table class="table items table-striped table-bordered table-condensed table-hover" id="soTable">
                          <thead>
                            <tr>
                              <th class="col-md-7">Chef Name (Chef Id )</th>
                              
                              <th class="col-md-1">On Time</th>
                              <th class="col-md-1 text-right">Off Time </th>
                ...
                <div class="col-md-12">
                  <div class="modal-footer" style="margin-bottom:10px;">
                    <input type="submit" class="btn btn-primary" value="Add " name="add_sale" id="add_sale">
...
<script src="<?php echo asset_url(); ?>js/form-validation-create_chef_schdule.js"></script> 
<script src="<?php echo asset_url(); ?>js/schdule.js"></script> 
...
function insertSalesData(){
		...
		var fields = $("#create_chef_schdule_form").serialize();		
	...
	$.post( "<?php echo base_url();?>chef/save_chef_schdule", fields)
	  .done(function( data ) {
		  var obj = jQuery.parseJSON(data);
			if(obj.error==1){
			...
			if(obj.error==0){
				...
				$("#soTable > tbody").empty();
				displayNotice('page','schdule successfully added!');
				
				clearForm();
				//empty footer details
				
				//alert(obj.sale_id);
				sendUrl='chef/schdule_list/'+obj.sale_id;
				//alert(sendUrl);
...
return false;
		 ...
		 bootbox.alert('Please add chef name.', function () {
...
function add_items(){
		...
		{
           source: '<?php echo base_url();?>chef/chef_name_suggestions?t='+$("#in_type").val(),
            minLength: 1,
            autoFocus: false,
            delay: 5,
            response: function (event, ui) {
			
				if (ui.content.length == 1 && ui.content[0].chef_id != 0)
				{
            ...
            select: function (event, data) {
				...
				if(data.item.value){
					...
					var tmp='';
					if(rowCount){
	  					tmp=isAddedProduct(data.item.chef_id);
					}
	   				if(!tmp){
				addProductToListByID(data.item.chef_id,data.item.chef_Fname);
					}else {
						calculateTotal();
					}
