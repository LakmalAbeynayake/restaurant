...
<body onLoad="window.print()">
    ...
    <div class="row">
        <div class="col-xs-12">
            <h3 class="text-center" style="margin-top: -10px;"> Transfer Note </h3>
            <span style="float:right;">Reference No: <?php echo $trnsfr_details['trnsfr_reference_no']; ?></span><br>
            <span style="float:right;">Date : <?php echo $trnsfr_details['trnsfr_datetime']; ?></span><br>
            <span style="float:right;">Printed on : <?php echo date("Y-m-d H:i a"); ?></span>
            <div class="col-xs-5">
                <h4>From:</h4>
                <strong>
                    <p style="font-size:20px"><?php echo $warehouse_details['name']; ?> (<?php echo $warehouse_details['code']; ?>)</p>
                </strong>
            ...
            <div class="col-xs-5 pull-right">
                <h4>To:</h4>
                <strong>
                    <p style="font-size:20px"><?php echo $to_warehouse_details['name']; ?> (<?php echo $to_warehouse_details['code']; ?>)</p>
                </strong>
                <p><?php echo $warehouse_details['address']; ?></p>
                <p>Tel: <?php echo $warehouse_details['phone']; ?></p>
            </div>
        ...
        <table class="print-table" width="100%">
            <thead>
                <tr class="report_view_th">
                    <th colspan="6" class="col-xs-1 text-right">
                        <!--<span style="float:right;">Reference No: <?php echo $trnsfr_details['trnsfr_reference_no']; ?></span><br>
                        <span style="float:right;">Date : <?php echo $trnsfr_details['trnsfr_datetime']; ?></span>-->
                    </th>
                </tr>
            ...
            <tbody>
                ...
                foreach ($trnsfr_item_list as $row) {
                    $tmpcount++;
                    $subtotal = 0;
                    $subtotal = $subtotal + $row['trnsfr_itm_quantity'] * $row['trnsfr_itm_unit_value'];
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:right; width:100px;"><?php echo number_format($row['trnsfr_itm_unit_value'], 2, '.', ','); ?></td>
