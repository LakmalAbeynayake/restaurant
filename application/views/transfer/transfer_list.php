                            ...
                            <div class="panel-heading">
                                ...
                                <div class="panel-tools" style="top:2px;">
                                    ...
                                    <ul class="dropdown-menu dropdown-light pull-right">
                                        <li>
                                            <a id="" data-toggle="modal" href="<?php echo base_url('transfer/add'); ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="col-sm-2 <?php echo $this->session->userdata('ss_group_id') < 3 || $this->session->userdata('ss_group_id') == 4 ? '':'collapse';?>">
                                        <div class="form-group">
                                            ...
                                            <select id="warehouse_id" class="form-control search-select" onchange="loadGrid()">
    ...
    <script>
        ...
        function loadGrid() {
            $('#warehouse_table').DataTable({
                "ajax": {
                    url : "<?php echo base_url('transfer/list_transfer') ?>",
                    data: {
        ...
        function click_transfer_view_btn(trnsfr_id) {
            var $modal = $('#ajax-modal');
            $('body').modalmanager('loading');
            setTimeout(function() {
                $modal.load('<?php echo base_url("transfer/transfer_details?trnsfr_id="); ?>' + trnsfr_id, '', function() {
                    $modal.modal();
        ...
        function fbs_click(id) {
            u = location.href;
            t = document.title;
            window.open('transfer/trnsfr_details?trnsfr_id=' + id, 'sharer', 'toolbar=0,status=0,width=626,height=700, left=10, top=10,scrollbars=yes');
            return false;
        }
    </script>
</body>
