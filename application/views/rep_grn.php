							...
							<div class="panel panel-default">
								<div class="panel-heading">
                                    ...
                                    <div class="panel-tools" style="top:2px;">
												<button onClick="JavaScript:fbs_click('<?php echo base_url('reports/print_grn?srh_warehouse_id=1'); ?>');" class="btn btn-blue dropdown-toggle" data-toggle="dropdown">
											...
											<div class="panel panel-default">
												<div style="font-weight: 700;" class="panel-heading"></div>
													<div class="panel-body">
                                                       ...
                                                       <select id="srh_supplier_id" class="form-control search-select" name="srh_supplier_id">
                                                               
																 <option value="">-Select-</option>
									                             <?php foreach ($supplier_list as $key => $sup) {
                                                       ...
                                                       <select id="srh_payment_status" class="form-control" name="srh_payment_status">
                                                        <option value="">-Select-</option>
...
function fbs_click(url) {
	...
	u=location.href;
	t=document.title;
	url='<?php echo base_url();?>'+'reports/print_grn?srh_warehouse_id='+srh_warehouse_id+'&srh_from_date='+srh_from_date+'&srh_to_date='+srh_to_date+'&srh_supplier_id='+srh_supplier_id+'&srh_payment_status='+srh_payment_status;
