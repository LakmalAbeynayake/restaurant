		...
		<div class="main-login col-sm-4 col-sm-offset-4">
			...
			<div class="box-login">
				...
				<form class="form-login" action="#" method="post" id="form-login">
					<div class="errorHandler alert alert-danger no-display" id="error_msg">
						<i class="fa fa-remove-sign"></i> Login Failed, Please try again
					</div>
			...
			<!-- start: COPYRIGHT -->
			<div class="copyright">
				2015 &copy; stock management system by sallelanka solutions.
			</div>
			<!-- end: COPYRIGHT -->
		</div>
		...
		<script>
			...
			function login(form) {
               ...
               $('body').modalmanager('loading');
                setTimeout(function () {
                    $.ajax({
                    url: "<?php echo base_url('users/login'); ?>", // Url to which the request is send
