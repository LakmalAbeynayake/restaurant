		...
		<div class="main-container">
			...
			<div class="main-content">
				...
				<div class="container">
					...
					<!-- start: PAGE CONTENT 
                    <!-- start grid -->
				<form class="bv-form" accept-charset="utf-8" method="post" enctype="multipart/form-data" role="form" action="<?php echo base_url('ingredient_grn/add'); ?>" id="add_perchas">
					<div class="row">
						<div class="col-md-12">
									...
									<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												$reference_no = $ref_id->gen_ref_number('id','ingredian_grn','GRN');
												?>
