            ...
            <div id="error"></div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-5 pull-right">
                   ...
                   <div class="form-group">
                        <h5>Details</h5>
                       <textarea type="text" class="form-control" name="acctrnss_details" id="acctrnss_details" ><?php if(isset($transactions_details['acctrnss_details'])){echo htmlentities($transactions_details['acctrnss_details']);}?> </textarea>
                       </div>
...
jQuery(document).ready(function() {
				...
				$('#acctrnss_date').datetimepicker({
				 format: 'YYYY/MM/DD',
				defaultDate:"<?php if(isset($transactions_details['acctrnss_date'])){ echo $transactions_details['acctrnss_date'];}?>"
				});
				 }
				 if($('#type').val()=="A"){
				$('#acctrnss_date').datetimepicker({
