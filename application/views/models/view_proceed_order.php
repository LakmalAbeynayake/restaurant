...
<body onLoad="window.print()">
     ...
     <?php $this->load->view("common/report_headerz.php"); ?>
  <?php /*?>   <?php foreach($proceed_item as $row){
		 print_r($row);
		 } ?><?php */?>
  <div class="row">
  <div class="col-xs-12">
...
<p>Proceed Order Reference No: <?php   print_r($proceed_ref_no[0]['proceed_ref_no'])?></p>
...
<th class="col-xs-2"><br/>Product Name</th>
<th class="col-xs-1"><br/>Quantity</th>
<th class="col-xs-1"><br/>Date</th>
...
<td style="width: 80px; text-align:center; vertical-align:middle;"><?php echo $row['po_item_quantity']; ?></td>
<td style="width: 80px; text-align:center; vertical-align:middle;"><?php echo $row['proceed_datetime_submit']; ?></td>
...
<?php
$Sales_Model = new Proceed_Order_Model();
?>
