                        ...
                        <tbody>
                            ...
                            <?php if ($sale_details['dine_type'] != 3) { ?>
                                ...
                                foreach ($sale_payments_list as $list) {
                                    ...
                                    $given_amount += $list->sale_pymnt_given_amount;
                                ...
                                if($given_amount - $allocated_payment < 0){
                                    ?>
                                    <tr>
                                        <td style="font-size:26px;text-align:left; font-weight:bold" colspan="2">Remaining Payment</td>
                                        <td style="text-align:right; font-weight:bold; border-bottom:4px double #000;">
                                            <p style="font-size:23px">
                                                <?php
                                                    echo number_format(($given_amount - $allocated_payment)*-1, 2, '.', ',')."A";
                                                ?>
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    ?>
                                    <tr>
                                        <td style="font-size:26px;text-align:left; font-weight:bold" colspan="2">Change</td>
                                        <td style="text-align:right; font-weight:bold; border-bottom:4px double #000;">
                                            <p style="font-size:23px">
                                                <?php
                                                    echo number_format($given_amount - $allocated_payment, 2, '.', ',');
                                                ?>
                                            </p>
                                        </td>
                                    </tr>
