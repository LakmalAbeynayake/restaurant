...
<div class="col-xs-5">
<h4>From:</h4>
<strong><p style="font-size:20px"><?php echo $warehouse_details['name']; ?> (<?php echo $warehouse_details['code']; ?>)</p></strong>
<p><?php echo $warehouse_details['address']; ?></p>
<p>Tel: <?php echo $warehouse_details['phone']; ?></p>
</div>
<div class="col-xs-5 pull-right">
<h4>To:</h4>
<strong><p  style="font-size:20px"><?php echo $to_warehouse_details['name']; ?> (<?php echo $warehouse_details['code']; ?>)</p></strong>
<p><?php echo $warehouse_details['address']; ?></p>
<p>Tel: <?php echo $warehouse_details['phone']; ?></p>
</div>
</div>
