            ...
            <div id="error"></div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <h5>Code *</h5>
                            <input type="text" class="form-control" name="cus_code" id="cus_code" <?php echo (isset($customer['cus_code']))?'value="'.$customer['cus_code'].'"':null;?> <?php if (isset($type)) if($type=='E') echo 'readonly';?>>
                       </div>
                       <div class="form-group">
                        <h5>Name *</h5>
                    ...
                    <div class="col-md-5 pull-right">
                       ...
                       <div class="form-group">
                        ...
                        <h5>TYPE </h5>
                            ...
                            <select style="width:100%" class="form-control search-select" id="cus_type_id" name="cus_type_id">
                           
							<?php 
                            foreach ($cus_type_list as $row)
                            {
								$sel='';
								$seldef='';
								if(isset($customer['cus_type_id'])){
									if($customer['cus_type_id']==$row['mct_id']){
										$sel=' selected="selected"';
									}
								}else{ 
								}
                            ?>       
                                <option<?php echo $sel;?><?php echo $seldef ?> value="<?php echo $row['mct_id'];?>"><?php echo $row['mct_name']; ?></option>
                             <?php }  ?>
                             </select>
                        </div>
                        ...
                        <h5>Country </h5>
                            ...
                            <select style="width:100%" class="form-control search-select" id="country_id" name="country_id">
...
var cus_type_id=$('#cus_type_id').val();
	...
	$.post( "<?php echo base_url('customers/save_customer');?>", {type:type, cus_id:cus_id, country_id:country_id, city_name:city_name, cus_name:cus_name, cus_code:cus_code, cus_email:cus_email, cus_phone:cus_phone, cus_address:cus_address, cus_state:cus_state, cus_postal_code:cus_postal_code,cus_type_id:cus_type_id })
	  .done(function( data ) {
