								  ...
								  <table class="table table-bordered table-condensed table-hover table-striped dataTable" id="products_table" style="overflow:scroll">
									  <thead>
                                          ...
                                          <!-- 	<th>Product Code</th> -->
                                            ...
                                            <th>Pur. Rtn.</th>
                                            <th>Sold</th>
                                            <th>Reject<!--Sales R QTY--></th>
                                            <th>Tra Out</th>
                                             <th class="">Tra In</th>
                                            <th class="">Balance</th>
                                             <th class="">Act. Balance</th>
                                            <!--
                                            <th class="col-md-1">Calculation</th> -->
                                            <th class="">Pur. Val.</th>
                                            <!-- 
                                            <th class="col-md-1">Calculation</th> -->
                                            <th>Sale Val.</th>
                                            <th>D/F</th>
                                             <th>D/F Value</th>
                                          <!--   <th class="col-md-1">commision</th> -->
                                            <!--
                                            <th>Product Code</th>
                                            <th style="text-align:left;">Product Name</th>
                                            <th>Category</th>
                                            <th>Sub Category</th>
                                            <th class="col-md-1">F.G.In Qty</th>
                                            <th class="col-md-1">F.G.R Qty</th>
                                            <th class="col-md-1">Sold Qty</th>
                                            <th class="col-md-1">Sales Return Qty</th>
                                            <th class="col-md-1">Damage Products</th>
                                            <th class="col-md-1" style="max-width:20px;">Sale Value</th>
                                            <th class="col-md-1" style="max-width:20px;">Cost Value</th>
                                            <th class="col-md-1" style="max-width:20px;">Balance Qty</th>-->
                                    </tr>
							          </thead>
                                     <!-- <tbody>
                                      <td></td>
...
//autoPrint:false,
											customize: function ( win ) {
												...
												$(win.document.body).find( 'h1' ).html("<center><?php echo $warehouse_details['name']; ?> Sales Report</center>");
...
//											message:	"Baker's Choice, \n <?php echo $warehouse_details['address']; ?></b>",
					        ...
					        "ajax": {
							'type': 'POST',
							'url': '<?php echo base_url('reports/get_list_product_for_print_v2');?>',
							'data': {
