<div class="print_only">
  <div>
    <div class="col-xs-12 text-center">
      ...
      <img alt="logo" src="<?php echo asset_url(); ?>images/logo.png" style="margin-top: 1px;width: 100px;">
    ...
    <div ><!--class="col-md-12"-->
      <table id="bill_table_print" class="print-table" style="width:100%">
        ...
        <tbody>
          ...
          <tr style="border-top:dashed;">
            ...
            <td style="text-align:right; padding-right:10px;" class="td_sub_total">&nbsp;</td>
          </tr>
          <tr style="display:none">
          ...
          <tr>
            ...
            <td style="text-align:right; padding-right:10px; font-size:16px; font-weight:bold; border-bottom:4px double #000;" class="id_total_amount"></td>
          </tr>
          <tr style="display:none">
      ...
      <br/>
      <p style="font-weight:bold;text-align:center"><i class="fa fa-facebook"></i>: bakerschoice.colombo
        <?php /*?><?php if($get_warehouse[0]->email) echo $get_warehouse[0]->email ?><?php */?>
      </p>
    </div>
  </div>
  ...
  <?php /*?><div style="padding-top:50px;" class=""> 
    ...
    <table id="kot_table_print" class="print-table" style="width:100%">
      <thead style="border-bottom:dashed;border-top:dashed">
        <tr class="report_view_th text-center">
...
<?php /*?><div class="modal-footer" style="border:none;display:none">
