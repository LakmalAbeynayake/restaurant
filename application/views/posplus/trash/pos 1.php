   ...
   <body>
      ...
      <div id="wrapper">
         <header id="header" class="navbar">
            <div class="container">
               <a class="navbar-brand" href="#"><span class="logo"><span class="pos-logo-lg">Baker' Choice POS System</span><span class="pos-logo-sm">POS</span></span></a>
                  ...
                  <ul class="nav navbar-nav pull-right">
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                           ...
                           <li>
                                	<a href="<?php echo base_url('dashboard'); ?>"><i class="fa-list"></i>
                                    	Classic Mode</a>
                           </li>
                           <li>
      ...
      <div id="category-slider">
         ...
         <?php foreach ($category as $key => $cat) { ?>
            <button id="category-<?php echo $cat->cat_id; ?>" type="button" value='<?php echo $cat->cat_id; ?>' class="btn-prni category">
               <img src="<?php echo asset_url(); ?>uploads/thumbs/<?php echo $cat->cat_image_thumb; ?>" style='width:60px;height:60px;' class='img-rounded img-thumbnail'/><span><?php echo $cat->cat_name; ?></span>
            </button>
         <?php } ?>
         </div>
      </div>
