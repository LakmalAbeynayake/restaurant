	...
	loadGrid();
       ...
       { extend: 'excel', text: 'Save as Excel',footer: true, message: message,title: ''},
               ...
               // "ajax": "<?php echo base_url('salary/get_salary_list') ?>",
				...
				if(col_1){
					col_1=accounting.formatMoney(col_1, "", 2, ",", ".");
				}
...
//        function update_fix_assets(fxd_ass_id) {
////alert(fxd_ass_id);	
//            var $modal = $('#ajax-modal');
//            $('body').modalmanager('loading');
//            setTimeout(function () {
//                $modal.load('<?php // echo base_url("fixed_assets/create_fixed_assets?fxd_ass_id=");    ?>' + fxd_ass_id, '', function () {
//                    $modal.modal();
//                    /*$("#country_id").select2();
//                     $(".search-select").select2({
//                     placeholder: "Select a State",
