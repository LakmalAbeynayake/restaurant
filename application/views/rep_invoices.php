...
<body>
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div style="overflow: scroll;height: 100px;">
                                                            <select id="customers_except" class="form-control search-select" name="customers_except[]" multiple style="width:100%;" onChange="change_filters()"> <!---->
                                                                <?php 
                                                    ...
                                                    <table class="table items table-striped table-bordered table-condensed table-hover" id="cash_collect">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="col-md-2 text-center">Total Sale</th>
                                                                <th class="col-md-1 text-center">Total Settled</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $sale_total   = 0;
                                                            $total_paid = 0;
                                                            foreach ($resp_customer_list as $row) {
                                                            ...
                                                            ?>
                                                                    <tr id="row_c_<?php echo $tmpcount; ?>" data-id="<?php echo $tmpcount; ?>">
                                                                        ...
                                                                        <td class="text-right"><?php echo ($row['sale_total'] - $row['total_paid']) ?></td>
                                                                    </tr>
                                                            <?php
                                                                }
                                                            }
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                <td></td>
                                                                <td></td>
                                                                <td class="text-right"><strong><?php echo $sale_total; ?> </strong></td>
                                                                <td class="text-right"><strong><?php echo $total_paid; ?> </strong></td>
                                                                <td class="text-right"><strong><?php echo $sale_total - $total_paid; ?> </strong></td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                </div>
    ...
    $(document).ready(function(){
        ...
        function change_filters() {
            ...
            sendUrl = 'reports/invoices?cus=' + val+'&li='+lo+'&mo='+mo+'&ct='+ct+'&ce='+ce;
