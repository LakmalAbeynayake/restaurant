...
class category_models extends CI_Model
{
    ...
    function category_update($category_tbl_id = '', $cat_id = '', $cat_name = '', $imgName = '', $imageThumb = '', $sts = '',$color='#000000',$bg_color='#ffffff')
    {
        $data1 = array(
            'cat_code' => $cat_id,
            'cat_name' => $cat_name,
    ...
    function category_change_pos_status($category_tbl_id = '', $status = '')
    {
        $cat_id = ($status == 0) ? 1 : 0;
        $data   = array(
            'pos_status' => $cat_id
