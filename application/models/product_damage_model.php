...
class Product_Damage_Model extends CI_Model
{
    ...
    {
        $this->db->select('product_damage_item.pdmgitm_unit_cost,product_damage_item.product_id, product.product_name, product.product_code, product_damage_item.pdmgitm_quantity');
    ...
    function get_all_product_damage()
    {
        ...
        $this->db->join('locations w', 't.warehouse_id = w.id', 'left');
